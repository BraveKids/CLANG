...
namespace UnityStandardAssets.Network {
    public class AutoLobbyPlayer : NetworkLobbyPlayer {
        ...
        public bool isPlayerJoinedMatch;
        ...
        public override void OnClientEnterLobby () {
            ...
            AutoLobbyPlayerList._instance.AddPlayer(this);
            //AutoLobbyPlayerList._instance.DisplayDirectServerWarning(isServer && LobbyManager.s_Singleton.matchMaker == null);
        ...
        void Update () {
            ...
            if (isLocalPlayer && !readyToBegin & !isPlayerJoinedMatch)
                OnReadyClicked();            
        }
        ...
        void SetupLocalPlayer () {
            ...
            if (playerName == "")
                CmdNameChanged("Player" + AutoLobbyPlayerList._instance.playerListContentTransform.childCount);
